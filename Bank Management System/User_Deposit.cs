...
{
    public partial class User_Deposit : Form
    {
        string ss = "";
        ...
        private void User_Deposit_Load(object sender, EventArgs e)
        {
            sqlcon.Open();
                ...
                else
                {
                    if(check_amount(textBox1.Text))
                    {
                        if(double.Parse(textBox1.Text) >=500)
                        {
                            ...
                            cm.ExecuteNonQuery();
                            sqlcon.Close();
                            MessageBox.Show("Money/Amount deposit in your account Successfully!");
                            this.Hide();
                            User_Option u = new User_Option(ss);
                            u.ShowDialog();
                        }
