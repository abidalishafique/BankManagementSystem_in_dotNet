...
{
    public partial class cashier1_deposit : Form
    {
        string ss = "";
        public cashier1_deposit(string s)
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        if (check_amount(textBox1.Text) && check_amount(textBox3.Text))
                        {
                            if (double.Parse(textBox1.Text) >= 500)
                            {
                                ...
                                if (dr1.HasRows)
                                {
                                    ...
                                    cm.ExecuteNonQuery();
                                    sqlcon.Close();
                                    MessageBox.Show("Money/Amount deposit in account Successfully!");
                                    this.Hide();
                        ...
                        {
                            MessageBox.Show("You enter an invalid amount or account no please enter correctly!...");
                        }
                    }
                    else
                    {
        ...
        private void cashier1_deposit_Load(object sender, EventArgs e)
        {
